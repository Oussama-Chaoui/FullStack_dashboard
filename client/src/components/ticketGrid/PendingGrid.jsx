...
import { useEditAdminStatusMutation, useGetAllTicketsQuery } from "state/api";

const PendingGrid = ({ user }) => {
  ...
  const customLocaleText = {
    noRowsLabel: "No pending tickets", // Replace with your desired text
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <ButtonGroup>
          <IconButton color="success" onClick={() => handleApprove(params)}>
            <CheckCircleOutlineOutlined />
          </IconButton>
          <IconButton color="error" onClick={() => handleDecline(params)}>
            <HighlightOffOutlined />
          </IconButton>
        </ButtonGroup>
      ),
